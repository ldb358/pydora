...
class Gui:
    ...
    def media_controls(self, albumArt):
        ...
        self.__buttons['stop'] = Button(self.__frame, text="stop");
        self.__buttons['stop'].grid(row=5, column=1, sticky="nesw");
        self.__buttons['skip'] = Button(self.__frame, text="skip");
        self.__buttons['skip'].grid(row=5, column=2, sticky="nesw");
        self.__buttons['stations'] = Button(self.__frame, text="stations");
        self.__buttons['stations'].grid(row=6, sticky="nesw");
    ...
    def login_controls(self):
        self.clear();
        loginFrame = Frame(self.__frame, padx=150, pady=180);
        ...
        self.__buttons['login'].grid(row=3, column=1, sticky="e")
